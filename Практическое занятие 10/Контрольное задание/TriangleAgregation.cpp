...
TriangleAgregation::TriangleAgregation(Dot& a, Dot& b, Dot& c)
    : a(a), b(b), c(c) 
{
    if( !isValid() )
    {
...
//---------------------------------------------------
//--.
tuple<double, double, double> TriangleAgregation::getSedeLength()
{   
    //--.
...
//---------------------------------------------------
//--.
double TriangleAgregation::getPerimetr()
{
    auto resSlen = getSedeLength();
...
//---------------------------------------------------
//--.
double TriangleAgregation::getSquare()
{
    auto resSlen = getSedeLength();
...
//---------------------------------------------------
//--.
bool TriangleAgregation::isValid()
{
    //--.
    auto resSlen = getSedeLength();
